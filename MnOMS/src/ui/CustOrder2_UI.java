...
public class CustOrder2_UI extends javax.swing.JFrame {

//    Waiter_UI ui;
    public Rooms newOrder;
//    public CustOrder2_UI(Waiter_UI ui) {
    public CustOrder2_UI() {
//        this.ui=ui;
        initComponents();
        ...
        //cmbRn.setSelectedItem(ui.changeOrder);
     }
    ...
    private void initComponents() {
        ...
        setBounds(new java.awt.Rectangle(350, 110, 0, 0));
        setResizable(false);
...
//        String cust=custNo.getText();
 ...
 //               new CustOrder2_UI(null).setVisible(true);
                 new CustOrder2_UI().setVisible(true);
            }
        });
    }
